...
collection <- jsonlite::read_json("https://raw.githubusercontent.com/addelany/neon4cast-catalog/main/stac/v1/collection/aquatics/output.json")
...
Providers:
```{r eval=TRUE, echo=FALSE}
#not sure if we need to print any of this -- may just be saved as metadata
