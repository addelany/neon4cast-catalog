...
scores_sites_df <- data.frame(site_id = scores_sites) |> drop_na()

write.csv(scores_sites_df, 'stac/ticks/scores/all_scores_sites.csv', row.names = FALSE)
