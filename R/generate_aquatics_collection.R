...
parent_url <- 'https://data.ecoforecast.org/forecasts/parquet/aquatics'
...
collection <- stac4cast::build_collection(id = id_info,
                               ...
                               assets = stac4cast::build_assets(thumbnail = stac4cast::build_thumbnail(href = 'https://ecoforecast.org/wp-content/uploads/2019/12/EFI_Logo-1.jpg', title = 'EFI Logo'),
                                                     parquet_items = stac4cast::build_parquet(href = 'https://data.ecoforecast.org/forecasts/parquet/aquatics',
                               ...
                               providers = stac4cast::build_providers(data_url = 'https://data.ecoforecast.org',
                                                                                 data_name = 'Ecoforecast Data',
                                                                                 host_url = 'https://ecoforecast.org',
